...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item The \icon{ConditionalTee}~ConditionalTee actors, ``happy'' and ``sad'' set the variable \texttt{@\{class\}} accordingly, with either ``happy'' or ``sad''.
  ...
  \item Inside the \icon{Trigger}~Trigger ``convert to arff'', we load the CSV file and turn it into an ARFF file, as the name suggests:
  \begin{itemize}
